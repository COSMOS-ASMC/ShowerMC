// ******** this must be placed before Zobsv.h ***********(due to NoOfSites(2))
/*
...
#define   ASHeightList	zobsc_.asheightlist
#define   ASDepthList	zobsc_.asdepthlist
#define   HeightList    zobsc_.heightlist
#define   DepthList     zobsc_.depthlist
#define   LatitOfSite   zobsc_.latitofsite
#define   LongitOfSite  zobsc_.longitofsite
#define   DtGMT         zobsc_.dtgmt
#define   XaxisFromSouth zobsc_.xaxisfromsouth
#define   YearOfGeomag  zobsc_.yearofgeomag
#define   ObsPlane      zobsc_.obsplane
#define   NoOfSites2   zobsc_.noofsites2
