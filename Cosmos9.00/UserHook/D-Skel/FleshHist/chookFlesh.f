...
#include "../../SkelFlesh/Zprivate.h"
      ...
      call xBgEvent
      call xihist                ! instanciate histogram
      call xclearNrfai           ! clear Nrfai region
      end
...
!          event number, primary      
      ...
      read( Mdev, end=1000, err=999 ) cumnum, num, SeedSave, 
#if defined (KEKB) || (KEKA)
#include "ZavoidUnionMap.h"
!////////////
!      write(0,*) ' rank=',mpirank,' ir=',SeedSave,' Zfirst=',
!     *   Zfirst.pos.depth*0.1, 'g/cm2'
!//////////////
#else
     * Zfirst
#endif
...
#include "Ztrackv.h"
      ...
      read(Mdev)  NoOfLowE
!/////////
!      write(0,*) ' rank=',mpirank,' NoOfLowE=',NoOfLowE
!//////////
      do  i = 1, NoOfLowE
#if defined (KEKA) || (KEKB)
         Zsave = Zfirst  ! save; next destroys Zfirst
         read(Mdev) 
#include "ZavoidUnionMap.h"
         aTrack = Zfirst
         Zfirst = Zsave   ! restore
#else
         read(Mdev) aTrack
#endif
