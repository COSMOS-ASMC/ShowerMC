...
!      To avoid reading it as default, it is stored here.
       data (adata(i), i = 1, 15)/
     1 '-400	290.75	1.2790 Air',
     2 '0	288.15	1.2250',
     3 '3.e3	268.659	 9.0925e-1',
     4 '6.e3	249.187	 6.6011e-1',
     5 '11.1e3	216.65	0.35932',
     6 '20.0e3	216.65	8.891e-2',
     7 '32.2e3	228.756	1.3145e-2',
     8 '47.4e3	270.65	1.4187e-3',
     9 '51.0e3	270.65	 9.0696e-4',
     a '72.0e3	214.263	 6.2374e-5',
     b '86.0e3	186.87	 6.958e-6',
     c '91.0e3	186.87	 2.860e-6',
     d '110.0e3	240.0	 9.708e-8',
     e '130.0e3	469.27	 8.152e-9',
     f '160.0e3	696.29	 1.233e-9'/

       data (adata(i), i=16, 24)/
     1 '250.0e3	941.33	 6.073e-11',
     2 '300.0e3	976.01	 1.916e-11',
     3 '400.0e3 995.83	 2.803e-12',
     4 '500.0e3	999.24	 5.215e-13',
     5 '600.0e3	999.85	 1.137e-13',
     6 '700.0e3	999.97	 3.070e-14',
     7 '800.0e3	999.99	 1.136e-14',
     8 '900.0e3	1000.0	 5.759e-15',
     9 '1.0e6	1000.0	 3.561e-15'/
       data adata(25)/' '/
