#
#
#        This give standard atmosphere data. The scale height is approximated
...
#
#  and d0 = rho0*H(z0).
#     Next 2 lines will improve the structure a litte.
# But we dont use, because we use other analytic formula
# below 11km
#
#	3.d3	268.659	7.0121e2	9.0925e-1
#	6.e3	249.187	4.7217e2	6.6011e-1
#
#
# height(m)   	Temp(K)		density(kg/m3)  
#-----------------------------------------------------------------
	0	288.15		1.2250
