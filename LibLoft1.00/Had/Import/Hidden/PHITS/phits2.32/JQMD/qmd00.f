...
c!!!!!!!!!!/
c               write(0,*) '******  qmdin '
c               write(0,*) '  ityp,ktyp,eein,mmas,mchg,bmax0'
c               write(0,*)  ityp,ktyp,eein,mmas,mchg,bmax0
c!!!!!!!!!!!!!!!
...
*-----------------------------------------------------------------------
c!!!!!!!!!!//
c               write(0,*) ' imadj=', imadj, ' in qmd00'
c!!!!!!!!!!!!!!!/
...
*-----------------------------------------------------------------------
c!!!!!!!!!!////
c      write(0,*) ' qmdevent ibch=', ibch, ' bmax,min=',
c     *    bmax, bmin
c      write(0, *) ' ntmax=', ntmax, ' irkg=',irkg
c      write(0, *)  ' icolt=', icolt
c!!!!!!!!!!!!!!!/
                  ierr =  0
