...
!       convert to HEP code 
      ...
      if(nhep.gt.nmxhep)then
         ...
         write(0,*) ' nmxhep ptcls are being  used'
         nhep = nmxhep
!////         stop
      endif
...
!!!!  /////////////
!               
!               p2 =  dot_product(a(n)%fm%p(1:3), a(n)%fm%p(1:3) )
!               mass2= a(n)%fm%p(4)**2 - p2
!
!               write(*,'(3i5,1p,6g15.5)')
!     *              a(n)%code, a(n)%subcode, a(n)%charge,
!     *              a(n)%fm%p(:), a(n)%mass, sqrt(mass2)
!///////////////               
            endif
         endif
      enddo
