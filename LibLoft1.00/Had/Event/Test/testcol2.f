...
!
     ...
     *              ia, iz, cms, xbyp
          ...
          call cqUHooki(1, modifyx)
          call cqUHookr(1, modifyxpw1)
          call cqUHookr(2, modifyxpw2)
          write(ErrorOut,*) ' modifyx=',modifyx, ' pw1,2=',
     *      modifyxpw1, modifyxpw2
!
!            2        3       4...
...
!///////
!                   if(a(j).code .eq. knuc) then
!                      xNmax = max(xNmax, x)
!                   elseif(a(j).code .eq. kpion) then
!                      xPimax = max(xPimax, x)
!                   endif
!////////////
