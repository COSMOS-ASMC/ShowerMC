...
c  #include "Zcode.h"     
        ...
        integer info             ! input. 0--> particle is still active.
                                 ...
                                 !         dies. or the energy is 
                                 !         < minimum at its birth)
...
!             10 is the max surface numbers (octagon  case)
...
!              2 below is for scintillation and Cerenkov light
        ...
        call epqFirstP(proc)
        write(0,*) 'firstP.z proc'
        write(0,*) firstP.z,  proc
        write(0,*) 'firstM.colElem, firstM.colA, firstM.colZ'
        write(0,*) firstM.colElem, firstM.colA, firstM.colZ

        first =.true.
        do i = 1, Ncomp
           call epqEloss(i, deT, deEff)    ! inquire dE
           if( deT > 0. ) then 
              if(first) then
                 write(*,*) 'comp#          dE           dEeff'
                 first = .false.
