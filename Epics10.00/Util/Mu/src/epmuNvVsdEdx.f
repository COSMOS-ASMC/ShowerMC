...
!        for muon nuclea interaction.
!          v  .vs.  Int v*ds/dv is written  on  stdout.
!
!             
!
#include "Zglobalc.h"
...
#include "ZmuBPNgene.h"
     ...
     *    "  '../../Data/BaseM/Pb')",  1)
      ...
      vmin = 0.145d0/Emu
      if(norm .eq. 5) then
         call epmuElossN(vmin, 1.d0, total)
