...
if( $#argv != 2 ) then
	echo "Usage: CreateXCOMTab.csh  basic_media_table_path  output_table_dir"
	exit 1
endif
if( ! -f $1 )  then
	echo $1 not exisst
...
echo "2)  postpone making tab (later you have to  make it)"
echo "Select the number "
     set maketab=$<
if ( $maketab != 1 ) then
  echo "you have to make the tab later (mandatory)."
