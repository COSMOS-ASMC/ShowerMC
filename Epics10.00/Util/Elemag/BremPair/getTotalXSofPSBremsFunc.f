#include "ZepicsBD.h"
      implicit none
!     select brems function 1 or 2 or 3 in get...mk
!     to get total XS of brems with some xmin for a given media
!     at partial screening region.
!     100 MeV to 10 GeV.  Even if complete screening can be
!     applied, at high enegies, we force to use p.s here.
#include "Zglobalc.h"
...
#include "ZepTrackp.h"
      ...
      media%cnst%BrEemaxS =0.01  ! Seltzer region is suppressed
     ...
     * " 3: /(g/cm2), 4:/cm, 5: area norm "
      ...
      Ek = E1
      Ee = Ek + masele
      media%cnst%BrScrE = 100.  !force p.s upto 100 GeV
