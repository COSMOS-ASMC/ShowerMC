...
END {
  ...
  if( ntv > 0 ) {
    ...
    system("echo ' ' >>" filex) ;
    system("echo "  color  ">>" filex); 
    if( system( "echo test -f tempvectvtx | sh " ) == 0 ) system("rm -f tempvectvtx");				 
    if( system( "echo test -f tempvectnv | sh " ) == 0 )  system("rm -f tempvectnv");
    if( system( "echo test -f tempvectcolor | sh " ) == 0 ) system("rm -f tempvectcolor");
  }
}
