...
!
     ...
     *      isa=6,  iea=7, ix0=8, iy0=9, ix1=10, iy1=11)
       ...
       real*8 ra, rb, h,  rap, sa, ea, r
!
       call eprpst(comp, 6, 11, 1, 6)
!
!           check some values
